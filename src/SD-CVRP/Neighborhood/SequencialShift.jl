...
export SequencialShift
mutable struct SequencialShift <: Neighbor
    ...
    SequencialShift(size::Int64 = 1; id="SequencialShift-default") = begin
        local hasMove    = false
        local shift_size = 1

        shift_size = size
        id === "SequencialShift-default" ? id = "SequencialShift-$shift_size" : nothing
...
export execute
function execute(cvrp_aux::CvrpAuxiliars, shift::SequencialShift, routes::Array{Route, 1}, deliveries::Array{Delivery, 1}) # Delta evaluation
...
export accept
function accept(_::CvrpAuxiliars, shift::SequencialShift, solution::Array{Route, 1})
...
export reject
function reject(cvrp_aux::CvrpAuxiliars, shift::SequencialShift)
