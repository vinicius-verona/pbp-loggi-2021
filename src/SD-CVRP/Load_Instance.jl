...
using JSON
using GZip
using CVRP_Structures: Point, Delivery, CvrpData, CvrpAuxiliars
...
"""
function loadDistanceMatrix(instance::String; k_nearest::Int64 = 100)::CvrpAuxiliars
    ...
    return CvrpAuxiliars(distances, size(distances)[1] * size(distances)[2], generateNearestAdjacent(k_nearest, distances))
end
